...
public class ViewHolder extends RecyclerView.ViewHolder {
    ...
    private com.example.payfast.ViewHolder.ClickListener mClickListener;
    public interface  ClickListener{
        void onItemClick(View view, int position);
    }

    public void setOnClickListener(com.example.payfast.ViewHolder.ClickListener clickListener){
