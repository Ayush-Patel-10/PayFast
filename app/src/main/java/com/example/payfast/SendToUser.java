...
public class SendToUser extends AppCompatActivity {
    ...
    com.example.payfast.CustomeAdapterSendToUser adapter;
    ...
    private void showData(String phonenumber) {
        ...
        adapter = new com.example.payfast.CustomeAdapterSendToUser(com.example.payfast.SendToUser.this, modelList_sendtouser);
    ...
    public void selectuser(int position) {
        ...
        while(cursor.moveToNext()) {
            ...
            startActivity(new Intent(com.example.payfast.SendToUser.this, Userlist.class));
            finish();
        }
    }
    ...
    public void onBackPressed() {
        AlertDialog.Builder builder_exitbutton = new AlertDialog.Builder(com.example.payfast.SendToUser.this);
        builder_exitbutton.setTitle("Do you want to cancel the transaction?").setCancelable(false)
                .setPositiveButton("yes", new DialogInterface.OnClickListener() {
                    @Override
                    public void onClick(DialogInterface dialogInterface, int i) {
                        new DatabaseHelper(com.example.payfast.SendToUser.this).insertTransferData(date, name, "Not selected", transferamount, "Failed");
                        Toast.makeText(com.example.payfast.SendToUser.this, "Transaction Cancelled!", Toast.LENGTH_LONG).show();
                        startActivity(new Intent(com.example.payfast.SendToUser.this, Userlist.class));
                        finish();
                    }
